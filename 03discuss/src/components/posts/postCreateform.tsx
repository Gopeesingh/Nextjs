...
type CreatePostFromProps = {
    slug: string
}

const PostCreateForm : React.FC<CreatePostFromProps> = ({slug}) => {
      ...
      <DialogContent className="sm:max-w-[425px]">
        <form action={action}>
          <DialogHeader>
            ...
            <DialogDescription>
              Write a new post. Click save when your done.
            </DialogDescription>
          </DialogHeader>
          ...
          {formState.errors.formError && <div className="border border-red-500 bg-red-200 p-2 rounded">{formState.errors.formError}</div>}
          </div>
          <DialogFooter>
